...
interface SafXInterface {
  openDocumentTree(persist: boolean, defaultUri : string): Promise<DocumentFileDetail | null>;
  openDocument(
    persist: boolean,
    multiple: boolean,
  ...
  unzip(uriString: string, destUri: string): Promise<void>;
 ...
 */
export function openDocumentTree(persist: boolean, defaultUri : string) {
  return SafX.openDocumentTree(persist, defaultUri);
}
...
export function unzip(uriString: string, destUri: string) {
    return SafX.unzip(uriString, destUri);
}
