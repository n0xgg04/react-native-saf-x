...
public class SafXModule extends ReactContextBaseJavaModule {
  ...
  public void openDocumentTree(final boolean persist,String defaultUri, final Promise promise) {
    this.efficientDocumentHelper.openDocumentTree(persist, defaultUri, promise);
  }
  ...
  @ReactMethod
  public void unzip(String uriString, String destUriString, final Promise promise) {
    this.efficientDocumentHelper.unzip(uriString, destUriString, promise);
  }
